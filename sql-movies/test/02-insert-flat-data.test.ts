...
const insertMovies = (movies: Movie[]) => {
  return (
    `insert into ${MOVIES} (imdb_id, popularity, budget, budget_adjusted, revenue, revenue_adjusted, original_title, homepage, 
    ...
    '${escape(movie.tagline ? movie.tagline : ' ')}', '${escape(movie.overview)}', ${movie.runtime},
