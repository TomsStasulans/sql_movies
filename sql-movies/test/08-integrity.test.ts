...
describe("Foreign Keys", () => {
  ...
  it(
    ...
    async done => {
      const directorId = 7;
      const query = `DELETE FROM movies WHERE id = ${directorId}`;
  ...
  it(
    ...
    async done => {
      const actorId = 10;
      const query = `DELETE FROM movies WHERE id = ${actorId}`;
      //delete actor by id
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const keywordId = 12;
      const query = `DELETE FROM movies WHERE id = ${keywordId}`;
  ...
  it(
    ...
    async done => {
      const companyId = 12;
      const query = `DELETE FROM movies WHERE id = ${companyId}`;
